...
urlpatterns = [
    ...
    path('api/v1/nodes/<node_id>/descendants/', views.get_descendants_api, name='get_descendants_api'),
    path('nodes/<node_id>/descendants/', views.get_descendants_gui, name='get_descendants_gui'),
